...
export default function About() {
  return (
    <div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 my-4">
            <div className="bg-white shadow-lg rounded-md px-4 py-3 my-4">
              <h3 className="text-blue-600 font-bold text-lg my-1">Safety</h3>
            ...
            <div className="bg-white shadow-lg rounded-md px-4 py-3 my-4">
              <h3 className="text-blue-600 font-bold text-lg my-1">People</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-md px-4 py-3 my-4">
              <h3 className="text-blue-600 font-bold text-lg my-1">Quality</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-md px-4 py-3 my-4">
              <h3 className="text-blue-600 font-bold text-lg my-1">Delivery</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white shadow-lg rounded-md px-4 py-3 my-4">
              <h3 className="text-blue-600 font-bold text-lg my-1">Cost</h3>
              <p className="text-gray-600">
          ...
          <div className="shadow-md px-5 py-4 rounded-md bg-white">
            <h2 className="text-blue-600 text-2xl font-bold my-2">
      ...
      <footer className="bg-gray-100 border-t-2 h-28 flex justify-center align-middle">
